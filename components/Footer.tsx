    ...
    <footer className="flexCenter  mb-16 ">
      <div className="padding-container max-container flex flex-col gap-14 w-full">
        <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row">
          ...
          <div className="flex flex-wrap gap-10 justify-center sm:justify-between md:flex-1">
              ...
              <FooterColumn title={FOOTER_CONTACT_INFO.title}>
                {FOOTER_CONTACT_INFO.links.map((link) => (
                  ...
                  >
                    ...
                    <p className="medium-14 whitespace-nowrap text-green-700">
                      {link.value}
                    </p>
                  </Link>
                ))}
        ...
        <p className=" regular-14 w-full text-center text-gray-30">
          &copy;2024 traVelo | All rights reserverd
        </p>
      </div>
    </footer>
  );
